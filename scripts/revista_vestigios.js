...
const PERIODICAL_CONFIG = {
  name: 'Vestígios: Revista Latino-Americana de Arqueologia Histórica',
  fileName: 'revista_vestigios.json',
  archiveUrls: [
    'https://periodicos.ufmg.br/index.php/vestigios/issue/archive/1',
    'https://periodicos.ufmg.br/index.php/vestigios/issue/archive/2',
  ],
  selectors: {
