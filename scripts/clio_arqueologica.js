...
const PERIODICAL_CONFIG = {
  ...
  fileName: 'clio_arqueologica.json',
  archiveUrls: [
    'https://periodicos.ufpe.br/revistas/index.php/clioarqueologica/issue/archive/1',
    'https://periodicos.ufpe.br/revistas/index.php/clioarqueologica/issue/archive/2',
    'https://periodicos.ufpe.br/revistas/index.php/clioarqueologica/issue/archive/3',
  ],
  selectors: {
