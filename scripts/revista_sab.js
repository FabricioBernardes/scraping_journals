...
const PERIODICAL_CONFIG = {
  name: 'Revista da Sociedade de Arqueologia Brasileira',
  fileName: 'revista_sab.json',
  archiveUrls: [
    'https://revista.sabnet.org/ojs/index.php/sab/issue/archive/1',
    'https://revista.sabnet.org/ojs/index.php/sab/issue/archive/2',
    'https://revista.sabnet.org/ojs/index.php/sab/issue/archive/3',
  ],
  selectors: {
